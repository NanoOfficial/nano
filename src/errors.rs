...
pub enum Error {
    ...
    #[cfg(feature = "nano-sdk")]
    #[error("Contract execution failed")]
    ContractError(nano_sdk::error::ContractError),
...
#[cfg(feature = "nano-sdk")]
impl From<nano_sdk::error::ContractError> for Error {
    fn from(err: nano_sdk::error::ContractError) -> Self {
